...
var testCases = map[string]struct {
	...
	"Transforms flat object": {
		...
		propertyList: PropertyEntryList{
			{KeyURI: "prefix1/name/string", Value: []byte("John")},
			{KeyURI: "prefix1/age/float64", Value: float64ToBinary(30)},
			{KeyURI: "prefix1/index/float64", Value: float64ToBinary(18446744073709551615)},
			{KeyURI: "prefix1/city/string", Value: []byte("New York")},
			{KeyURI: "prefix1/active/bool", Value: []byte(strconv.FormatBool(true))},
		},
	},
